...
Basically, you need to send the `network` value in the crypto currency object that you get in the response of [GET crypto currencies list API](https://docs.payfura.com/payfura-apis/list-of-crypto-currencies).
